...
def torch_chunk_gated_delta_rule(
    ...
    Args:
        query: Query tensor of shape
            (batch_size, seq_len, num_value_heads, key_head_dim)
        key: Key tensor of shape
            (batch_size, seq_len, num_value_heads, key_head_dim)
        value: Value tensor of shape
            (batch_size, seq_len, num_value_heads, value_head_dim)
        g: Gate/decay tensor of shape (batch_size, seq_len, num_value_heads)
        beta: Scalar/beta tensor of shape (batch_size, seq_len, num_value_heads)
    ...
    Returns:
        ...
        - output: Shape (batch_size, seq_len, num_value_heads, value_head_dim)
        - final_state: Shape (batch, num_value_heads, key_head_dim, value_head_dim)
            or None
    """
...
def torch_recurrent_gated_delta_rule(
    ...
    Args:
        ...
        g: Gate/decay tensor of shape (batch_size, seq_len, num_value_heads)
        beta: Scalar/beta tensor of shape (batch_size, seq_len, num_value_heads)
        initial_state: Initial recurrent state. Shape:
